...
console.log('humanity data at start:', humanity.data());



function actWSRecv(data) {
  var plan;
  console.log(' actWSRecv');
  try {
...
var actChannel = camp.ws('act', function actWSStart(socket) {
...
function gameTurn() {
  ...
  console.log('game turn:', JSON.stringify(updatedHumanity));
